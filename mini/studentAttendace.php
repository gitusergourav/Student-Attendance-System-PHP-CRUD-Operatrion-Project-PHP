  ...
  <body>
    ...
    <div class="ms-3 my-4">
        <div class="badge bg-success text-wrap">
            <h1 class="">Student Attendance</h1>
        </div>
    </div>
    ...
    <div class="table-responsive mt-4">
        <table class="table table-hover">
            ...
            <?php
                ...
                $registered_name = $_SESSION['username'];
                $sql = "SELECT * FROM `registered_student` WHERE `registered_by`='$registered_name' ";
...
<script>
        ...
        Array.from(edits).forEach((element)=>{
            element.addEventListener("click",(e)=>{
                ...
                // console.log(e.target.id);
                  ...
                  window.location.href = "studentAttendace.php?roll_no="+roll_no+"&enroll_no="+enroll_no+"&name="+name+"&status="+sts;
        ...
        Array.from(edits2).forEach((element)=>{
            element.addEventListener("click",(e)=>{
                ...
                window.location.href = "studentAttendace.php?roll_no="+roll_no+"&enroll_no="+enroll_no+"&name="+name+"&status="+sts2;
...
<?php
  ...
  if(isset($_GET['roll_no']) and isset($_GET['enroll_no'])  and isset($_GET['name']))
  {
    ...
    $taken_by_attendance = $_SESSION['username'];
